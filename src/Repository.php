...
use BlackCat\Database\Packages\PolicyAlgorithms\Repository\PolicyAlgorithmRepository;
...
{
    private PolicyAlgorithmRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PolicyAlgorithmRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto|null
    {
