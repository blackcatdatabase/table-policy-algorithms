...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'policy_algorithms'; }
    public static function contractView(): string { return 'vw_policy_algorithms'; }
    /** @return string[] */
    public static function columns(): array { return [ 'policy_id', 'algo_id', 'role', 'weight', 'priority', 'created_at', 'updated_at' ]; }
     ...
     * policy_id algo_id role may be "id" or "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = trim('policy_id algo_id role');
        if ($raw === '') {
            throw new \InvalidArgumentException('Definitions::pkColumns(): token policy_id algo_id role must not be empty.');
        }
    ...
    public static function defaultOrder(): ?string {
        $c = trim('created_at DESC, policy_id algo_id role DESC'); return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> list of unique keys */
    public static function uniqueKeys(): array { return [ [ 'policy_id', 'algo_id', 'role' ] ]; }
    ...
    public static function intColumns(): array { return [ 'policy_id', 'algo_id', 'weight', 'priority' ]; }
