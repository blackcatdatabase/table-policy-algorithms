...
namespace BlackCat\Database\Packages\PolicyAlgorithms\Mapper;

use BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto;
use BlackCat\Database\Packages\PolicyAlgorithms\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO PolicyAlgorithmDto:
...
final class PolicyAlgorithmDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'policy_id' => 'policyId', 'algo_id' => 'algoId' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'policy_id', 'algo_id', 'weight', 'priority' ];
    /** @var string[] */
     ...
     * @return PolicyAlgorithmDto
     */
    public static function fromRow(array $row): PolicyAlgorithmDto
    {
        /** @var PolicyAlgorithmDto */
        return DtoHydrator::fromRow(
            PolicyAlgorithmDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?PolicyAlgorithmDto
    {
     ...
     *
     * @param PolicyAlgorithmDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PolicyAlgorithmDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PolicyAlgorithmDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PolicyAlgorithmDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PolicyAlgorithmDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PolicyAlgorithmDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PolicyAlgorithmDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PolicyAlgorithmDto>
     */
