...
final class PolicyAlgorithmsModule implements ModuleInterface
{
    public function name(): string { return 'table-policy_algorithms'; }
    public function table(): string { return 'policy_algorithms'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_algorithms', 'table-encryption_policies' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_pa_algo', 'fk_pa_policy' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_pa_algo', 'fk_pa_policy' ],
        ];
    }
}
