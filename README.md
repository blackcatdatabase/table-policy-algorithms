...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: none · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\policy-algorithms](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\policy-algorithms)
...
graph LR
  ...
  policy_algorithms["policy_algorithms"]:::center
  policy_algorithms -->|FK| crypto_algorithms["crypto_algorithms"]:::link
  policy_algorithms -->|FK| encryption_policies["encryption_policies"]:::accent
...
- Outbound (depends on): "crypto_algorithms", "encryption_policies"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package policy-algorithms -Apply
