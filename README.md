...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 0 · Changelog: fresh (18 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package policy-algorithms -Apply
