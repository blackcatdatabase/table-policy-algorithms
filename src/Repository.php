...
namespace BlackCat\Database\Packages\PolicyAlgorithms;
...
use BlackCat\Database\Packages\PolicyAlgorithms\Repository\PolicyAlgorithmRepository as GeneratedRepository;
...
{
  private PolicyAlgorithmRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PolicyAlgorithmRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PolicyAlgorithmRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PolicyAlgorithms\Dto\PolicyAlgorithmDto|null { return $this->repo->getById($id, $asDto); }
